...
import com.example.Flats.Food_Fusion.jwt.CustomerUserDetailsService;
import com.example.Flats.Food_Fusion.jwt.JwtFilter;
import com.example.Flats.Food_Fusion.jwt.JwtUtil;
import com.example.Flats.Food_Fusion.Model.User;
import com.example.Flats.Food_Fusion.Repository.UserRepo;
        ...
        try{
            if(this.validateSignupMap(requestMap)){
                ...
                if(Objects.isNull(user)){
                    ...
                    return FFFUtils.getResponseEntity("Successfully Registered", HttpStatus.OK);
                }else{
                    return FFFUtils.getResponseEntity("Email exists",HttpStatus.BAD_REQUEST);
                }
            }else {
                return  FFFUtils.getResponseEntity("Invalid Data",HttpStatus.BAD_REQUEST);
            }
